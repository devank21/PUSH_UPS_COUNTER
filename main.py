...
def run_pose_detection(mp_drawing, mp_pose, filename):
    ...
    # Read video
    cap = cv2.VideoCapture(r'C:\Users\devan_jmbn6cf\OneDrive\Documents\hackathon_foitness\pushup.mp4')
    ...
    with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
        while 1:
            ...
            # Display timer
            image = display_clock_icon(image,r'C:\Users\devan_jmbn6cf\OneDrive\Documents\hackathon_foitness\clock.png', height, width)
...
if __name__ == "__main__":
    ...
    run_pose_detection(mp_drawing, mp_pose, r'C:\Users\devan_jmbn6cf\OneDrive\Documents\hackathon_foitness\pushup.mp4')
# run_pose_detection(mp_drawing, mp_pose, 'C:\\Users\\devan_jmbn6cf\\OneDrive\\Documents\\hackathon_foitness\\pushup.mp4')
